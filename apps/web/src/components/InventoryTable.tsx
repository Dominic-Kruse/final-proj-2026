    ...
    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
      ...
      <div className="overflow-x-auto">
        <table
          ...
          style={{ minWidth: 860, fontSize: 13 }}
        >
          <thead>
            <tr className="bg-slate-50 border-b border-slate-200">
              <th className="text-left px-5 py-2 text-[10px] font-bold uppercase tracking-widest text-slate-400">
                Product · Unit
              </th>
              <th className="text-left px-3 py-2 text-[10px] font-bold uppercase tracking-widest text-slate-400">
                Generic · Form
              </th>
              <th className="text-left px-3 py-2 text-[10px] font-bold uppercase tracking-widest text-slate-400">
                Category
              </th>
              <th className="text-right px-3 py-2 text-[10px] font-bold uppercase tracking-widest text-slate-400">
                Total stock
              </th>
              <th className="text-center px-3 py-2 text-[10px] font-bold uppercase tracking-widest text-slate-400">
                Shelf
              </th>
              <th className="text-center px-3 py-2 text-[10px] font-bold uppercase tracking-widest text-slate-400">
                Batches
              ...
              <th className="text-right px-5 py-2 text-[10px] font-bold uppercase tracking-widest text-slate-400">
                Actions
              </th>
            </tr>
          </thead>
                ...
                <Fragment key={product.productId}>
                    ...
                    >
                      <div className="inline-flex items-center gap-1.5">
                        ...
                        <button
                          ...
                          className="w-8 h-8 p-0 flex items-center justify-center rounded-lg border border-slate-300 bg-slate-100 hover:bg-slate-200 text-slate-900 transition-colors shadow-sm"
                        >
                          <ChevronDown
                  ...
                  {isExpanded && (
                    <tr>
                      <td
                        colSpan={8}
                        className="bg-slate-50 px-5 py-3 border-t border-slate-100"
                      >
                        ...
                        {product.batches.length === 0 ? (
                          ...
                          <div className="rounded-xl border border-slate-200 overflow-hidden">
                            ...
                            >
                              <thead>
                                <tr className="bg-slate-50 border-b border-slate-200">
                                  <th className="text-left px-4 py-2 text-[10px] font-bold uppercase tracking-widest text-slate-400">
                                    Batch no.
                                  </th>
                                  <th className="text-left px-4 py-2 text-[10px] font-bold uppercase tracking-widest text-slate-400">
                                    Supplier
                                  ...
                                  <th className="text-right px-4 py-2 text-[10px] font-bold uppercase tracking-widest text-slate-400">
                                    Qty
                                  </th>
                                  <th className="text-left px-4 py-2 text-[10px] font-bold uppercase tracking-widest text-slate-400">
                                    Share of stock
                                    ...
                                    >
                                      ...
                                      <td className="px-4 py-2.5">
                                        <div className="flex items-center gap-1.5">
                                          ...
                                          <span className="text-[10px] text-slate-400 tabular-nums w-7">
                                            {pct}%
                                          </span>
                                        </div>
                                      </td>
