      ...
      <aside className={`${collapsed ? "w-20" : "w-64"} bg-white border-r border-slate-200 flex flex-col h-full shrink-0 transition-[width] duration-300 ease-in-out`}>
        ...
        <div className="px-3 pb-4">
          <button
            ...
            className={`w-full flex items-center justify-center p-2 rounded-lg border border-slate-200 bg-slate-200 text-slate-600 hover:bg-slate-100 hover:text-slate-800 transition-all ${!collapsed ? "rotate-180" : ""}`}
          >
